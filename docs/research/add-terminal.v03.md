# Add terminal & unified launch profiles — Research (stepped v03)

**Date:** 2026-04-03  
**Status:** In Progress — research for PRD amendment & implementation plan  
**Preceding:** `add-terminal.v02.md`  
**Changes from v02:** Documented **orchestration vs API contract** (ANSI stepped / web async / stateless jump-to-operation); added **§8 gap analysis** — where the repo is short of that goal and what to adjust  
...
Progression: `diff -u docs/research/add-terminal.v02.md docs/research/add-terminal.v03.md`
...
- **Cursor CLI** on remote: profile-specific launcher.
...
| Goal (v03) | Current state | Adjustment |
|------------|---------------|------------|
...
*Stepped v03 — next: `cp` → `add-terminal.v04.md` after NOTES or approval revision; merge into PRD when direction is approved.*
