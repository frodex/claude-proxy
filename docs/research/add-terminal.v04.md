# Add terminal & unified launch profiles — Research (stepped v04)
...
*Stepped v04 — next: `cp` → `add-terminal.v05.md` after NOTES or approval revision; merge into PRD when direction is approved.*
