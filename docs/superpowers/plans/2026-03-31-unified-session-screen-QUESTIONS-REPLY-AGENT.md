...
Sequential walk-through is intentional. The user SEES all fields at once (full-form rendering) but advances through them one by one with Enter. This is the "lobby style" — works like a form where you tab through fields. USER: I'm ok letting user move around form with arrow keys like lobby, not a forced a, b, c completion sequence, they are free to submit at any time.
