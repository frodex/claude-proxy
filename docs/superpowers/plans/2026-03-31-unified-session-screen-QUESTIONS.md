...
`docs/superpowers/plans/2026-03-31-unified-session-screen-QUESTIONS-REPLY.md`
...
|-------|--------|------|---------|------|
| name | active, empty | active, pre-filled | active, pre-filled | active, pre-filled as `X-fork_01` |
| runas | active (admin only) | locked | locked | locked |
| server | active (admin only) | locked | locked | locked |
| workdir | active, empty | active, pre-filled | active, pre-filled | active, pre-filled |
